...
<html dir="ltr" mozdisallowselectionprint moznomarginboxes>
  <head>
	...
	<!--#endif-->
	    ...
	    <link rel="stylesheet" href="<%=request.getContextPath()%>/resource/pdf_js/web/viewer.css"/>
	
	<!--#if !(MOZCENTRAL || CHROME || MINIFIED)-->
	    <script src="<%=request.getContextPath()%>/resource/pdf_js/web/compatibility.jscompatibility.js"></script>
	<!--#endif-->
	
	<!--#if !PRODUCTION-->
	    <script src="<%=request.getContextPath()%>/resource/pdf_js//external/webL10n/l10n.js"></script>
	<!--#endif-->
	
	<!--#if !PRODUCTION-->
	    <script src="<%=request.getContextPath()%>/resource/pdf_js/src/shared/util.js"></script>
	    <script src="<%=request.getContextPath()%>/resource/pdf_js/src/display/api.js"></script>
	    <script src="<%=request.getContextPath()%>/resource/pdf_js/src/display/metadata.js"></script>
	    <script src="<%=request.getContextPath()%>/resource/pdf_js/src/display/canvas.js"></script>
	    <script src="<%=request.getContextPath()%>/resource/pdf_js/src/display/webgl.js"></script>
	    <script src="<%=request.getContextPath()%>/resource/pdf_js/src/display/pattern_helper.js"></script>
	    <script src="<%=request.getContextPath()%>/resource/pdf_js/src/display/font_loader.js"></script>
	    <script src="<%=request.getContextPath()%>/resource/pdf_js/src/display/annotation_helper.js"></script>
	    <script>PDFJS.workerSrc = '<%=request.getContextPath()%>/resource/pdf_js/src/worker_loader.js';</script>
	<!--#endif-->
	...
	<!--#if !PRODUCTION-->
	    <script src="<%=request.getContextPath()%>/resource/pdf_js/web/ui_utils.js"></script>
	    <script src="<%=request.getContextPath()%>/resource/pdf_js/web/default_preferences.js"></script>
	    <script src="<%=request.getContextPath()%>/resource/pdf_js/web/preferences.js"></script>
	    <script src="<%=request.getContextPath()%>/resource/pdf_js/web/download_manager.js"></script>
	    <script src="<%=request.getContextPath()%>/resource/pdf_js/web/view_history.js"></script>
	    <script src="<%=request.getContextPath()%>/resource/pdf_js/web/page_view.js"></script>
	    <script src="<%=request.getContextPath()%>/resource/pdf_js/web/thumbnail_view.js"></script>
	    <script src="<%=request.getContextPath()%>/resource/pdf_js/web/text_layer_builder.js"></script>
	    <script src="<%=request.getContextPath()%>/resource/pdf_js/web/document_outline_view.js"></script>
	    <script src="<%=request.getContextPath()%>/resource/pdf_js/web/document_attachments_view.js"></script>
	    <script src="<%=request.getContextPath()%>/resource/pdf_js/web/pdf_find_bar.js"></script>
	    <script src="<%=request.getContextPath()%>/resource/pdf_js/web/pdf_find_controller.js"></script>
	    <script src="<%=request.getContextPath()%>/resource/pdf_js/web/pdf_history.js"></script>
	    <script src="<%=request.getContextPath()%>/resource/pdf_js/web/secondary_toolbar.js"></script>
	    <script src="<%=request.getContextPath()%>/resource/pdf_js/web/presentation_mode.js"></script>
	    <script src="<%=request.getContextPath()%>/resource/pdf_js/web/grab_to_pan.js"></script>
	    <script src="<%=request.getContextPath()%>/resource/pdf_js/web/hand_tool.js"></script>
	    <script src="<%=request.getContextPath()%>/resource/pdf_js/web/overlay_manager.js"></script>
	    <script src="<%=request.getContextPath()%>/resource/pdf_js/web/password_prompt.js"></script>
	    <script src="<%=request.getContextPath()%>/resource/pdf_js/web/document_properties.js"></script>
	<!--#endif-->
	
	<!--#if !MINIFIED -->
	    <script src="<%=request.getContextPath()%>/resource/pdf_js/web/debugger.js"></script>
	    <script src="<%=request.getContextPath()%>/resource/pdf_js/web/viewer.js"></script>
	<!--#else-->
	<!--#include viewer-snippet-minified.html-->
	<!--#endif-->
	<script type="text/javascript">
		var DEFAULT_URL = 'downloadFile?fileName=${context.context}';
	</script>
  </head>
  <body tabindex="1">
          ...
          <div id="toolbarContainer">
            <div id="toolbarViewer">
              <div id="toolbarViewerLeft">
                ...
                <input type="number" id="pageNumber" class="toolbarField pageNumber" value="1" size="4" min="1" tabindex="9" style="text-align: center;">
